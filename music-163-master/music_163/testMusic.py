...
class Comments(object):
    ...
    params = {
        'csrf_token': 'e3bebe825c52667eb4274846ba9bcb01'
    }

    data = {
        'params': 'WFOtVk+WoNn0fEbiXdeZBfZQ3pdfcPAxOp/1p8Zol8BtFNRxiXNftbHpISSkh9WSkLsJrKCHNcekorYEDEJYXK/5PpKtwnaK1Hf1Fj7mNZxC/F184P8GguReeRrc/hX0q6//lRo22V9L09482p0Wp9DnpZCd1Ywt5UzF6Lxi+lLTlTVoQ8Voll81VX7nYnFsZ0xzdyNzuDKcJtcuD7zZnrNyEjiLqV07Nm0gFPDRUX0=',
        'encSecKey': ''
    }
...
if __name__ == '__main__':
    ...
    save_comments(music_before, False, connection1)


    # t1 = threading.Thread(target=save_comments, args=(music_before, False, connection1))
